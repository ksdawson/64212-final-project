...
def create_traj_db(iiwa1_config, iiwa2_config):
    ...
    # Compute all trajectories for each square for each iiwa
    moves_db = {}
    for iiwa_instance in range(1, 3):
        ...
        for src_sq in get_squares():
            ...
            try:
                ...
                print('to_post_pick KTO failed: ', e)
            ...
            try:
                ...
                print('from_post_pick KTO failed: ', e)
            ...
            for piece, height in piece_heights.items():
                try:
                    ...
                    print('to_pick KTO failed: ', e) # need to for the from
                    continue
                try:
